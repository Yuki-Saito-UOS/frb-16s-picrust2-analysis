...
The public-release rerun was performed with Python 3.12.3, NumPy 2.2.5, pandas 2.3.2, SciPy 1.17.1, statsmodels 0.14.6, Matplotlib 3.10.8, and pypdf 6.16.2. These direct dependencies are pinned in `pyproject.toml`. QIIME 2 was run from the `quay.io/qiime2/amplicon:2024.10` image, pinned by digest in the workflow scripts; PICRUSt2 version 2.5.1 was run from `quay.io/biocontainers/picrust2:2.5.1--pyhdfd78af_0`.
